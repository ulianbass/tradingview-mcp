...
The config block is: { "mcpServers": { "TradingView MCP": { "command": "node", "args": ["/Users/YOUR_USERNAME/tradingview-mcp/versions/v1/src/server.js"] } } } — replace YOUR_USERNAME with my actual username.
...
```json
{
  "mcpServers": {
    "TradingView MCP": {
      "command": "node",
      "args": ["/Users/YOUR_USERNAME/tradingview-mcp/versions/v1/src/server.js"]
    }
  }
}
```
...
| `tv` command not found | Run `npm link` from `versions/v1` |
