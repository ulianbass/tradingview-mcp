...
El bloque de config es: { "mcpServers": { "TradingView MCP": { "command": "node", "args": ["/Users/TU_USUARIO/tradingview-mcp/versions/v1/src/server.js"] } } } — reemplaza TU_USUARIO con mi usuario real.
...
```json
{
  "mcpServers": {
    "TradingView MCP": {
      "command": "node",
      "args": ["/Users/TU_USUARIO/tradingview-mcp/versions/v1/src/server.js"]
    }
  }
}
```
...
| Comando `tv` no encontrado | Corre `npm link` desde `versions/v1` |
